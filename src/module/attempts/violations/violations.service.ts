...
export class ViolationsService {
    ...
    async createRules(orgId: string, dto: SaveViolationRulesDto) {
        ...
        rules.max_score_allowed = dto.max_score_allowed ?? rules.max_score_allowed ?? 30;
        rules.time_interval_seconds = dto.time_interval_seconds ?? rules.time_interval_seconds ?? 30;
        ...
        if (dto.violation_weights !== undefined) {
            ...
            const activeViolationTypes = Object.values(ViolationType)
            ...
            for (const type of activeViolationTypes) {
                ...
                normalizedWeights[type] = (submittedValue !== undefined && submittedValue !== null)
