...
export class TransactionsController {
    ...
    async getOneOrganizationAllTransactions(
        ...
        return await this.paymentsservice.getPlatformTransactionsByOrgId(orgId,organization);
    }
    ...
    async getOneOrganizationSingleTransaction(
        ...
        return await this.paymentsservice.getSinglePlatformTransaction(orgId, transactionId,organization);
    }
  ...
  // =====================================================================
    ...
    async getOrganizationStudentsTransactions(
       @Query('orgId') orgId: string,
        ...
        return await this.paymentsservice.getOrganizationStudentsTransactions(orgId, organization);
    }
   ...
   @Get('/organization/student/transactions/single/:transactionId')
    ...
    async getStudentSingleTransaction(
        ...
        return await this.paymentsservice.getStudentSingleTransaction(transactionId, userId, orgId, organization);
    }
  ...
  @Get('/organization/student/transactions/all')
    ...
    async getOneStudentAllTransactions(
        ...
        return await this.paymentsservice.getOneStudentAllTransactions(userId, orgId, organization);
    }
