...
export class CreateQuestionNestedDto {
  ...
  @Length(10, 1000, {
    message: 'Question text must be between 10 and 1000 characters long.',
  })
  ...
  @IsEnum(CorrectAnswer, {
    message: 'Correct answer must be one of the valid options: a, b, c, or d.',
  })
...
export class CreateTestSetDto {
  ...
  @Length(3, 255, {
    message: 'Test set name must be between 3 and 255 characters.',
  })
  name: string;
  ...
  @Max(100, {
    message: 'A single test section cannot exceed a maximum of 100 questions.',
  })
  ...
  @IsBoolean({
    message: 'Negative marking flag must be a boolean value (true or false).',
  })
  is_negative_marking: boolean;

  @IsEnum(NegativeMarkingOption, {
    message:
      'Negative score value must be a valid option from your configuration enum.',
  })
...
export class UpdateTestSetDto {
  ...
  @IsString({ message: 'Description must be a valid string.' })
  @Length(0, 2000, {
    message: 'The exam rules/description cannot exceed 2000 characters.',
  })
  description?: string;
